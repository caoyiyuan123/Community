...
<head>
    ...
    <script type="text/javascript" src="../../../js/community/register.js"></script>
...
<div class="login_box" style="overflow: scroll;width: 100%;height: 400px">
    <form action="${pageContext.request.contextPath}/register/registerSuccess" method="post">
        <table class="table" cellspacing="10px">
            ...
            <tr>
                ...
                <td class="login_button" colspan="2">
                    <input type="submit" id="register" value="注册" class="submit">
                    </input>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
                <td></td>
            </tr>
